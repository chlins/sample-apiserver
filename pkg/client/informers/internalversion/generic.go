...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case wardle.SchemeGroupVersion.WithResource("configmapreplicas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Wardle().InternalVersion().ConfigMapReplicas().Informer()}, nil
