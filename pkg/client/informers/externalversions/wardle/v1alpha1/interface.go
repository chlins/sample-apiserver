...
type Interface interface {
	// ConfigMapReplicas returns a ConfigMapReplicaInformer.
	ConfigMapReplicas() ConfigMapReplicaInformer
...
// ConfigMapReplicas returns a ConfigMapReplicaInformer.
func (v *version) ConfigMapReplicas() ConfigMapReplicaInformer {
	return &configMapReplicaInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
