...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1alpha1_ConfigMapReplica_To_wardle_ConfigMapReplica,
		Convert_wardle_ConfigMapReplica_To_v1alpha1_ConfigMapReplica,
		Convert_v1alpha1_ConfigMapReplicaList_To_wardle_ConfigMapReplicaList,
		Convert_wardle_ConfigMapReplicaList_To_v1alpha1_ConfigMapReplicaList,
		Convert_v1alpha1_ConfigMapReplicaSpec_To_wardle_ConfigMapReplicaSpec,
		Convert_wardle_ConfigMapReplicaSpec_To_v1alpha1_ConfigMapReplicaSpec,
		Convert_v1alpha1_ConfigMapReplicaStatus_To_wardle_ConfigMapReplicaStatus,
		Convert_wardle_ConfigMapReplicaStatus_To_v1alpha1_ConfigMapReplicaStatus,
...
func autoConvert_v1alpha1_ConfigMapReplica_To_wardle_ConfigMapReplica(in *ConfigMapReplica, out *wardle.ConfigMapReplica, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_ConfigMapReplicaSpec_To_wardle_ConfigMapReplicaSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_ConfigMapReplicaStatus_To_wardle_ConfigMapReplicaStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_ConfigMapReplica_To_wardle_ConfigMapReplica is an autogenerated conversion function.
func Convert_v1alpha1_ConfigMapReplica_To_wardle_ConfigMapReplica(in *ConfigMapReplica, out *wardle.ConfigMapReplica, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigMapReplica_To_wardle_ConfigMapReplica(in, out, s)
}

func autoConvert_wardle_ConfigMapReplica_To_v1alpha1_ConfigMapReplica(in *wardle.ConfigMapReplica, out *ConfigMapReplica, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_wardle_ConfigMapReplicaSpec_To_v1alpha1_ConfigMapReplicaSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_wardle_ConfigMapReplicaStatus_To_v1alpha1_ConfigMapReplicaStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_wardle_ConfigMapReplica_To_v1alpha1_ConfigMapReplica is an autogenerated conversion function.
func Convert_wardle_ConfigMapReplica_To_v1alpha1_ConfigMapReplica(in *wardle.ConfigMapReplica, out *ConfigMapReplica, s conversion.Scope) error {
	return autoConvert_wardle_ConfigMapReplica_To_v1alpha1_ConfigMapReplica(in, out, s)
}

func autoConvert_v1alpha1_ConfigMapReplicaList_To_wardle_ConfigMapReplicaList(in *ConfigMapReplicaList, out *wardle.ConfigMapReplicaList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]wardle.ConfigMapReplica)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_ConfigMapReplicaList_To_wardle_ConfigMapReplicaList is an autogenerated conversion function.
func Convert_v1alpha1_ConfigMapReplicaList_To_wardle_ConfigMapReplicaList(in *ConfigMapReplicaList, out *wardle.ConfigMapReplicaList, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigMapReplicaList_To_wardle_ConfigMapReplicaList(in, out, s)
}

func autoConvert_wardle_ConfigMapReplicaList_To_v1alpha1_ConfigMapReplicaList(in *wardle.ConfigMapReplicaList, out *ConfigMapReplicaList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]ConfigMapReplica)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_wardle_ConfigMapReplicaList_To_v1alpha1_ConfigMapReplicaList is an autogenerated conversion function.
func Convert_wardle_ConfigMapReplicaList_To_v1alpha1_ConfigMapReplicaList(in *wardle.ConfigMapReplicaList, out *ConfigMapReplicaList, s conversion.Scope) error {
	return autoConvert_wardle_ConfigMapReplicaList_To_v1alpha1_ConfigMapReplicaList(in, out, s)
}

func autoConvert_v1alpha1_ConfigMapReplicaSpec_To_wardle_ConfigMapReplicaSpec(in *ConfigMapReplicaSpec, out *wardle.ConfigMapReplicaSpec, s conversion.Scope) error {
	out.Namespace = in.Namespace
	out.SourceConfigMapName = in.SourceConfigMapName
	out.TargetNamespaces = *(*[]string)(unsafe.Pointer(&in.TargetNamespaces))
	return nil
}

// Convert_v1alpha1_ConfigMapReplicaSpec_To_wardle_ConfigMapReplicaSpec is an autogenerated conversion function.
func Convert_v1alpha1_ConfigMapReplicaSpec_To_wardle_ConfigMapReplicaSpec(in *ConfigMapReplicaSpec, out *wardle.ConfigMapReplicaSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigMapReplicaSpec_To_wardle_ConfigMapReplicaSpec(in, out, s)
}

func autoConvert_wardle_ConfigMapReplicaSpec_To_v1alpha1_ConfigMapReplicaSpec(in *wardle.ConfigMapReplicaSpec, out *ConfigMapReplicaSpec, s conversion.Scope) error {
	out.Namespace = in.Namespace
	out.SourceConfigMapName = in.SourceConfigMapName
	out.TargetNamespaces = *(*[]string)(unsafe.Pointer(&in.TargetNamespaces))
	return nil
...
// Convert_wardle_ConfigMapReplicaSpec_To_v1alpha1_ConfigMapReplicaSpec is an autogenerated conversion function.
func Convert_wardle_ConfigMapReplicaSpec_To_v1alpha1_ConfigMapReplicaSpec(in *wardle.ConfigMapReplicaSpec, out *ConfigMapReplicaSpec, s conversion.Scope) error {
	return autoConvert_wardle_ConfigMapReplicaSpec_To_v1alpha1_ConfigMapReplicaSpec(in, out, s)
}

func autoConvert_v1alpha1_ConfigMapReplicaStatus_To_wardle_ConfigMapReplicaStatus(in *ConfigMapReplicaStatus, out *wardle.ConfigMapReplicaStatus, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_ConfigMapReplicaStatus_To_wardle_ConfigMapReplicaStatus is an autogenerated conversion function.
func Convert_v1alpha1_ConfigMapReplicaStatus_To_wardle_ConfigMapReplicaStatus(in *ConfigMapReplicaStatus, out *wardle.ConfigMapReplicaStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigMapReplicaStatus_To_wardle_ConfigMapReplicaStatus(in, out, s)
}

func autoConvert_wardle_ConfigMapReplicaStatus_To_v1alpha1_ConfigMapReplicaStatus(in *wardle.ConfigMapReplicaStatus, out *ConfigMapReplicaStatus, s conversion.Scope) error {
	return nil
}

// Convert_wardle_ConfigMapReplicaStatus_To_v1alpha1_ConfigMapReplicaStatus is an autogenerated conversion function.
func Convert_wardle_ConfigMapReplicaStatus_To_v1alpha1_ConfigMapReplicaStatus(in *wardle.ConfigMapReplicaStatus, out *ConfigMapReplicaStatus, s conversion.Scope) error {
	return autoConvert_wardle_ConfigMapReplicaStatus_To_v1alpha1_ConfigMapReplicaStatus(in, out, s)
}
